...
import { VideoVersions } from "@/components/video-versions"
...
export default function ProjectTabs({ project, uploads, versions, messages, userRole, userId }: ProjectTabsProps) {
